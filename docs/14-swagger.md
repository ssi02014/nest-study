...
1. [Swagger/OpenAPI란?](#1-swaggeropenapi란)
2. [@nestjs/swagger 패키지와 핵심 구성 요소](#2-nestjsswagger-패키지와-핵심-구성-요소)
3. [주요 데코레이터 정리](#3-주요-데코레이터-정리)
4. [DTO에서 자동 스키마 생성](#4-dto에서-자동-스키마-생성)
5. [Swagger CLI 플러그인](#5-swagger-cli-플러그인)

### 2단계: 기본 예제

6. [기본 예제: Swagger 설정하기](#6-기본-예제-swagger-설정하기)
7. [기본 예제: DTO에 @ApiProperty 추가하기](#7-기본-예제-dto에-apiproperty-추가하기)
8. [기본 예제: 인증 설정하기](#8-기본-예제-인증-설정하기)
9. [API 버전 관리](#9-api-버전-관리)

### 3단계: 블로그 API 적용

10. [블로그 API 적용: 패키지 설치 및 Swagger 설정](#10-블로그-api-적용-패키지-설치-및-swagger-설정)
11. [블로그 API 적용: 컨트롤러에 Swagger 데코레이터 추가](#11-블로그-api-적용-컨트롤러에-swagger-데코레이터-추가)
12. [블로그 API 적용: DTO에 @ApiProperty 추가](#12-블로그-api-적용-dto에-apiproperty-추가)
13. [블로그 API 적용: Bearer 인증 설정](#13-블로그-api-적용-bearer-인증-설정)
14. [프로젝트 구조](#프로젝트-구조)
...
## 2. @nestjs/swagger 패키지와 핵심 구성 요소
...
## 7. 기본 예제: DTO에 [@ApiProperty](references/decorators.md#apipropertyoptions) 추가하기
...
## 10. 블로그 API 적용: 패키지 설치 및 Swagger 설정
...
## 11. 블로그 API 적용: 컨트롤러에 Swagger 데코레이터 추가
...
export class AuthController {
  ...
  @ApiBadRequestResponse({
    description:
      '유효하지 않은 요청 데이터 (이메일 형식 오류, 비밀번호 길이 부족 등)',
  })
...
export class PostsController {
  ...
  @ApiBadRequestResponse({
    description: '유효하지 않은 요청 데이터 (제목 누락, 내용 길이 부족 등)',
  })
  @ApiUnauthorizedResponse({ description: '인증되지 않은 요청' })
  create(
  ...
  @ApiOperation({
    summary: '게시글 수정',
    description:
      '자신이 작성한 게시글을 수정합니다. 작성자만 수정할 수 있습니다.',
  })
  @ApiParam({ name: 'id', description: '게시글 ID', type: Number, example: 1 })
  @ApiOkResponse({
  ...
  @ApiOperation({
    summary: '게시글 삭제',
    description:
      '자신이 작성한 게시글을 삭제합니다. 작성자만 삭제할 수 있습니다.',
  })
  @ApiParam({ name: 'id', description: '게시글 ID', type: Number, example: 1 })
...
export class CommentsController {
  ...
  @ApiOperation({
    summary: '댓글 삭제',
    description:
      '자신이 작성한 댓글을 삭제합니다. 작성자만 삭제할 수 있습니다.',
  })
...
## 12. 블로그 API 적용: DTO에 [@ApiProperty](references/decorators.md#apipropertyoptions) 추가
...
export class CreatePostDto {
  ...
  @ApiProperty({
    description: '게시글 내용',
    example:
      'NestJS에서 Swagger를 설정하는 방법을 알아봅니다. @nestjs/swagger 패키지를 사용하면 ...',
    minLength: 10,
  })
  @IsString()
  @MinLength(10)
...
export class PostResponseDto {
  ...
  @ApiProperty({
    description: '게시글 내용',
    example: 'NestJS에서 Swagger를 설정하는 방법을 알아봅니다...',
  })
  content: string;
