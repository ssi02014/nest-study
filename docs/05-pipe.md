...
> **핵심:** Pipe에서 예외가 발생하면 컨트롤러 핸들러는 **실행되지 않는다**. 잘못된 데이터가 비즈니스 로직에 도달하는 것을 사전에 차단할 수 있다.
...
### 9-5. UpdatePostDto (PartialType 활용)
...
### 9-8. 컨트롤러에 DTO와 ParseIntPipe 적용
